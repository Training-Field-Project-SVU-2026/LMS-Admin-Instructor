...
class StudentAdminDesktopScreen extends StatefulWidget {
  ...
  @override
  State<StudentAdminDesktopScreen> createState() => _StudentAdminDesktopScreenState();
}
  ...
  void _onScroll() {
    if (_scrollController.position.pixels >= _scrollController.position.maxScrollExtent - 50) {
      ...
      if (state is StudentAdminLoaded && !state.isPaginationLoading) {
        context.read<StudentAdminBloc>().add(GetStudentsAdminEvent(page: state.studentAdminUIModel.currentPage + 1));
      }
    }
  }
        ...
        child: Column(
          ...
          children: [
            CustomAddRowWidget(
              ...
              description: context.tr("create_update_manage_student_profiles_assignments"),
                ...
                builder: (context, state) {
                  if (state is StudentAdminLoading) {
                    ...
                    return CustomDataTable(
                      ...
                      data: state.studentAdminUIModel.students.cast<CustomDataTableRowModel>(),
